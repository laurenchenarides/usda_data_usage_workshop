...
<button onclick="document.getElementById('pdfPopup').style.display='block'" class="btn btn-primary">View Workshop Report</button>

<div id="pdfPopup" style="display:none; position:fixed; top:50%; left:50%; transform:translate(-50%, -50%); padding:20px; background-color:white; box-shadow:0px 0px 10px 0px rgba(0,0,0,0.2);">
  <h2>Workshop Report</h2>
  <p>Click the button below to view the PDF of the workshop report.</p>
  <a href="workshop_report.pdf" target="_blank" class="btn btn-primary">View PDF</a>
  <button onclick="document.getElementById('pdfPopup').style.display='none'" class="btn btn-secondary">Close</button>
</div>
